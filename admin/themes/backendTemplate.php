	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">Saranda 55</a>
	        </div>
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            <li class="<?php echo (currentpage() == 'index.php') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/index.php" >Home</a></li>
	            <li class="<?php echo (currentpage() == 'mod_room') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_room/index.php">Dhomat</a></li>
	            <li class="<?php echo (currentpage() == 'mod_roomtype') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_roomtype/index.php">Llojet e dhomave</a></li>
	            <li class="<?php echo (currentpage() == 'mod_reservation') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_reservation/index.php">Rezervimet</a></li>
	            <li class="<?php echo (currentpage() == 'mod_comments') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_comments/index.php">Komente</a></li> 
	            <li class="<?php echo (currentpage() == 'mod_reports') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_reports/index.php">Reporte</a></li>
	            <?php if($_SESSION['admin_ACCOUNT_TYPE']=="Administrator"){ ?>
	             <li class="<?php echo (currentpage() == 'mod_users') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_users/index.php" >Përdoruesit</a></li>
