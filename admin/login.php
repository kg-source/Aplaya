...
if (isset($_POST['btnlogin'])) {
    ...
    if ($uname == '' OR $upass == '') {
?>    <script type="text/javascript">
                alert("Emri ose Password i gabuar!");
                </script>
            <?php
...
?>    <script type="text/javascript">
                alert("Emri ose Password jo të rregjistruar! Kontakto administratorin.");
                window.location = "index.php";
                </script>
        <?php
        }
    ...
    <div class="container">
      ...
      <form class="form-signin" method="POST" action="login.php">
        ...
        <label class="checkbox">
          <input type="checkbox" value="remember-me"> Kujto të dhënat
        </label>
