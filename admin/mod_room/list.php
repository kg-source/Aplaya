...
<div class="container">
	<?php
		...
		<!-- <div class="panel panel-primary"> -->
			...
			<h3 align="left">Lista e Dhomave</h3>
				...
				<table id="example" class="table table-striped" cellspacing="0">
				  ...
				  <thead>
				  	...
				  	<th>No.</th>
				  		...
				  		Dhoma</th>
				  		<th align="left"  width="200">Përshkrimi</th>
				  		<th align="left" width="120">Tipi</th>
				  		<th align="left" width="120">Cmimi</th>
				  		<th align="left" width="90">Klientët</th>
				  		<th align="left"  width="200">Përshkrimi</th>
