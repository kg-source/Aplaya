        ...
        <div class="">
          ...
          <tbody>
            ...
            foreach ($cur as $result) {
                ...
                echo '<td >1</td>';
                echo '<td > &#8364 '. $_SESSION['magbanua_cart'][$i]['magbanuaroomprice'].'</td>';
          ...
          <tfoot>
            <tr>
              <td colspan="4"><h5><b> <?php  echo isset($_SESSION['pay']) ? 'Order Total: &#8364 '. $_SESSION['pay'] :'Your booking cart is empty.';?></b></h5></td><td colspan="5"> 
