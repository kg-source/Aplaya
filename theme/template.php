...
<title>Saranda 55: <?php echo $title; ?></title>
...
<!-- 
	            ...
	            <li><a href="<?php echo WEB_ROOT; ?>index.php?page=7">Contact and Location</a></li> 
				<li><a href="https://wa.me/17671017483">WhatsApp</a></li> 
				<li><a href="https://www.instagram.com/idealestatecenter?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">Instagram</a></li>  				              
	          </ul>
	        </div><!-- /.nav-collapse -->
	      </div><!-- /.container -->
	    </div><!-- /.navbar -->
				...
				<!-- <div class="well"> -->
				 <div style="float:left; width:370px; margin-left:15px;"> 
                        <div style="float:left; width:70px; margin-bottom:10px;"> 
                            <img src="<?php echo WEB_ROOT; ?>images/vista-aplaya-resort.png" width="1110px" height="300px" style="-webkit-border-radius:5px; -moz-border-radius:5px;" alt="Image">
                        </div>
                    </div>
